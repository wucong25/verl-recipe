...
# 修改为当前需要跑的用例路径
DEFAULT_SH="recipe/async_flow/run_async_grpo_qwen3_30b_gsm8k_local.sh"
echo "Use $DEFAULT_SH"
...
NPUS_PER_NODE=16
# 修改为对应主节点IP
MASTER_ADDR="${MASTER_ADDR:-"<your-master-node-ip>"}"
# 修改为当前节点的通信网卡
SOCKET_IFNAME="${SOCKET_IFNAME:-"<your-socket-ifname>"}"
